...
class WhisperBindings {
  ...
  ffi.Pointer<Utf8> transcribe(
    ffi.Pointer<whisper_context> ctx,
    ffi.Pointer<Utf8> file_path,
  ) {
    return _transcribe(
      ctx,
      file_path,
  ...
  late final _transcribePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<Utf8> Function(
              ffi.Pointer<whisper_context>, ffi.Pointer<Utf8>)>>('transcribe');
  late final _transcribe = _transcribePtr.asFunction<
      ffi.Pointer<Utf8> Function(
          ffi.Pointer<whisper_context>, ffi.Pointer<Utf8>)>();
